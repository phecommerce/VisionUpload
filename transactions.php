...
//Get Traffic data values for each active hotel
$transactionValues = $googleData->getTransactionValues($getHotelList);

//Update Values into Database
$updateTransaction = $db->updateTransactionData($transactionValues);
